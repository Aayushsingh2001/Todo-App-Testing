...
beforeAll(async()=>{
    ...
    ("mongodb+srv://devops:devops@todoappdb.hkuit.mongodb.net/todoapp-test")
});
...
//Disconnect from the test database after all test case passed succesfully
afterAll(async()=>{
...
describe('Todo Api tests', ()=>{
    ...
    test("GET /api/todos- should return all todos", async()=>{
        ...
        expect(response.body[1].status).toBe();
    })
